#!/bin/bash
# Setup script for Claude Code Hooks on macOS

set -e

echo "===================================="
echo "Claude Code Hooks Setup for macOS"
echo "===================================="
...
if [ ! -d "$HOOKS_DIR" ]; then
    ...
    echo "Please ensure you're running this script from the CLAUDE directory"
    exit 1
fi
...
EOF
    ...
    # Expand variables to actual paths in the settings file
...
check_command "shfmt" || echo "   Install: brew install shfmt"
check_command "clang-format" || echo "   Install: brew install clang-format"
check_command "jq" || echo "   Install: brew install jq"
check_command "gofmt" || echo "   Install: Install Go language"
check_command "rustfmt" || echo "   Install: Install Rust language"
check_command "xmllint" || echo "   Install: Usually pre-installed on macOS"
